"""W3 dual-GS multi-scene serial driver.

Same logic as run_w2_sotaview_all_scenes.py, but points at the W3 dual-GS
configs (which inherit W2-sotaview and add a ``dual_gs`` block to enable
CoR-GS-style co-reg + co-prune over a second independently-initialized
Gaussian field).
"""
...
def cfg_for(scene: str) -> Path:
    if scene == "lego":
        return ROOT / "configs" / "_w3_dual_gs" / "lego_n8_w3_dual_gs.yaml"
    return ROOT / "configs" / "_w3_dual_gs" / f"blender_{scene}_n8_w3_dual_gs.yaml"
...
def main() -> int:
    ...
    print("\n==================================================")
    print("W3 dual-GS 8-scene driver summary:")
